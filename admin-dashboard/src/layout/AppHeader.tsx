...
function resolveDisplayName(user: AdminHeaderUser | null) {
...
const AppHeader: React.FC = () => {
  ...
  const [user, setUser] = useState<AdminHeaderUser | null>(null);
  ...
  useEffect(() => {
    ...
    const onProfileUpdated = (e: Event) => {
      const detail = (e as CustomEvent<AdminHeaderUser>).detail;
      ...
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link to="/" className="lg:hidden">
            <img
              className="h-12 w-45 dark:hidden"
              src="/ACOM_LOGO.png"
              alt="Logo"
            />
            <img
              className="hidden h-12 w-45 dark:block"
              src="/ACOM_LOGO.png"
              alt="Logo"
            />
          </Link>
