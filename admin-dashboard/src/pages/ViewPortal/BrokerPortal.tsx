  ...
  return (
    <div className="w-full space-y-4 text-gray-900 dark:text-gray-100">
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1 max-w-xl text-sm text-white/80">
              Search active broker organizations and open their portal in a new
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        {[
          {
            label: debouncedSearch ? "Matching brokers" : "Total brokers",
            value: total,
            icon: LayoutGrid,
            iconWrap:
                    ...
                    >
                      <td className="relative px-5 py-4 sm:px-6">
                        ...
                        <div className="flex items-center gap-3.5">
                          <div
                            className={`relative flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br text-sm font-bold text-white ring-2 ring-white dark:ring-slate-900 ${avatarTone(broker.name)}`}
                          >
                            {broker.profileImage ? (
                              <img
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="mt-0.5 truncate font-mono text-[11px] text-gray-400">
                              {shortOrgId(broker.organizationId)}
                            </p>
                          </div>
                        </div>
                      </td>
