...
const CreateTemplateImproved: React.FC = () => {
  ...
  return (
    <div className="bg-[#F8FAFC] dark:bg-slate-950 flex items-center justify-center p-4">
      {/* Background Effects */}
      ...
      <div className="relative w-full max-w-5xl bg-white/70 dark:bg-slate-900/80 backdrop-blur-2xl border border-white/60 dark:border-slate-800 rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.15)] overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-10 lg:p-16 border-r border-slate-100 dark:border-slate-800">
          <div className="mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#13538A]/10 dark:bg-[#13538A]/20 text-[#13538A] dark:text-[#1873c3] rounded-full text-xs font-bold mb-4">
          ...
          <div className="space-y-10">
            {/* NAME */}
            <div className="group">
              <label className="text-[12px] font-black text-slate-400 uppercase tracking-widest mb-4 block group-focus-within:text-[#13538A] dark:group-focus-within:text-[#1377cf]">
                Template Name
              </label>
            ...
            {/* DESCRIPTION */}
            <div className="group">
              <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-4 block group-focus-within:text-[#13538A] dark:group-focus-within:text-[#1377cf]">
                Description
              </label>
            ...
            <button
              disabled={loading}
              onClick={handleSave}
              className="relative group w-full md:w-auto overflow-hidden bg-[#13538A] text-white px-10 py-4 rounded-2xl font-bold transition-all hover:shadow-[0_20px_40px_-12px_rgba(19,83,138,0.5)] disabled:opacity-60"
            >
              ...
              <div className="absolute inset-0 bg-[#1b72be] opacity-0 group-hover:opacity-100 transition-opacity" />
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 bg-slate-50 dark:bg-slate-950/40 p-10 flex items-center justify-center border-t md:border-t-0">
          <div className="relative w-full max-w-[320px]">
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 shadow border border-slate-100 dark:border-slate-800 max-w-full overflow-hidden min-h-[400px] flex flex-col justify-between">
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-slate-900    dark:text-white break-words line-clamp-2">
                  {name || "Template Title"}
                </h3>

                <p className="text-slate-500 dark:text-slate-400 text-sm break-words line-clamp-10">
