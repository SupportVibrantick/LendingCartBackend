...
const TemplateCard: React.FC<{
  ...
  return (
    <div className="group relative bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 p-2 shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-100/50 dark:hover:shadow-indigo-900/40">
  ...
  className="py-4 rounded-2xl font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 mt-5 w-full bg-[#13538A] text-white hover:bg-[#1b72be] dark:bg-[#13538A] dark:text-white dark:hover:bg-[#1b72be]"
>
  Manage Template
</button>
      </div>
...
const TemplateDetailsModal: React.FC<{
  ...
  return (
    <div
      className="fixed inset-0 z-[99999] bg-black/60 backdrop-blur-lg flex items-center justify-center p-4"
                      ...
                      .map((f) => (
                        <div key={f.id}>
                          ...
                          {f.fieldType === "NUMBER" && (
                            <input
                              type="number"
                              className="w-full border rounded px-3 py-2 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100"
                            />
                          )}
                          ...
                          {f.fieldType === "FILE" && (
                            <input
                              type="file"
                              className="w-full border rounded px-3 py-2 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 text-slate-400"
                            />
                          )}
      ...
      <div className="min-h-screen bg-[#F8FAFC] dark:bg-slate-950 p-10">
        ...
        <div className="flex flex-col items-center mb-16 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-900 rounded-full shadow-sm border border-slate-200 dark:border-slate-700 mb-6">
            <LayoutTemplate size={16} className="text-[#13538A] dark:text-[#197bd0]" />
          ...
          <h1 className="text-4xl font-black mb-4 text-slate-900 dark:text-white">
            All{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#13538A] to-[#1b72be]">
