...
const AddTemplateProducts: React.FC = () => {
    ...
    const loadTemplates = async () => {
        try {
            ...
            const res = await fetch(
                `${API_BASE}/admin/applications/templates`,
    ...
    return (
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 space-y-5 max-w-xl">
            <div className="flex items-center gap-2 text-slate-800 dark:text-slate-100 font-semibold">
                <PackageCheck className="text-indigo-500" size={20} />
                Add Loan Products to Template
            </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-56 overflow-y-auto border rounded-xl p-3
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700
                   text-white py-3 rounded-xl font-semibold transition disabled:opacity-60"
            >
                {saving ? (
                    <>
