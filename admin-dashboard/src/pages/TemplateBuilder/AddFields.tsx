    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4">
      <div className="max-w-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 space-y-6 w-full">
        <div className="flex items-center gap-2 font-semibold text-slate-800 dark:text-slate-100">
          <ListChecks className="text-[#13538A] drop-shadow-sm" />
        ...
        {selectedSectionId && (
          <div className="border-t pt-5 space-y-4">
            ...
            <button
              ...
              disabled={saving}
              className="w-full flex items-center justify-center gap-2 bg-[#13538A] hover:bg-[#1b72be] text-white py-3 rounded-xl font-semibold transition disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {saving ? (
                <>
