...
/** @deprecated alias for existing admin call sites */
...
export function buildBrokerSubBrokerFormData(form: CoBrokerFormState): FormData {
  ...
  if (resolvedForm.allowedToLogin && resolvedForm.password) {
    ...
    append(
      "confirmPassword",
      resolvedForm.confirmPassword || resolvedForm.password,
    );
  }
...
/** @deprecated use buildBrokerSubBrokerFormData */
export function buildCoBrokerFormData(form: CoBrokerFormState) {
  return buildBrokerSubBrokerFormData(form);
}
...
export type BrokerSubBrokerFormState = CoBrokerFormState;
export type BrokerSubBrokerFormErrors = CoBrokerFormErrors;
export const INITIAL_BROKER_SUB_BROKER_FORM = INITIAL_CO_BROKER_FORM;
export const validateBrokerSubBrokerForm = validateCoBrokerForm;
export const mapDetailToBrokerSubBrokerForm = mapDetailToForm;
