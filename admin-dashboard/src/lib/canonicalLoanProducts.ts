...
export function filterLenderCatalogProducts<T extends CatalogProduct>(
  ...
  return products.filter(
    (product) => !LENDER_HIDDEN_PRODUCT_CODES.has(product.code),
  );
}
