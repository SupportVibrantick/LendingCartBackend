...
function BrandLogo({
  ...
  const resolvedLogoUrl = logoUrl ? resolvePdfLogoUrl(logoUrl) : null;
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ padding: "14px 32px 0" }}>
          <div
            style={{
              background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 55%, ${primaryColor} 100%)`,
              borderRadius: "12px",
              padding: "4px 6px",
              color: "#ffffff",
