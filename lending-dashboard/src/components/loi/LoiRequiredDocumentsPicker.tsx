    ...
    <div className="mt-6 border-t border-slate-100 pt-5 dark:border-slate-800">
      ...
      <div className="relative mb-3">
        ...
        <input
          ...
          className="w-full rounded-xl border border-slate-200 bg-white py-2.5 pl-9 pr-3 text-sm outline-none focus:border-[#183b57] dark:border-slate-700 dark:bg-slate-800"
        />
      </div>
          ...
          <div className="flex flex-wrap gap-2">
            {selectedDocuments.map((documentName) => (
              <button
                ...
                className="rounded-full bg-[#183b57] px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-[#264863]"
      ...
      <div className="mt-3 flex gap-2">
        <input
          ...
          className="flex-1 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:border-[#183b57] disabled:opacity-60 dark:border-slate-700 dark:bg-slate-800"
        />
        <button
          type="button"
