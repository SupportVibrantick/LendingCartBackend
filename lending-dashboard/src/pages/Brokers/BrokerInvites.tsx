    ...
    <div className="px-6 py-6 text-gray-900 dark:text-gray-100">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">
          Invited <span className="text-[#18B6B4]">Brokers</span>
        </h1>
      ...
      <div className="rounded-xl border bg-white dark:bg-slate-900 dark:border-slate-700">
        {loading ? (
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              {invites.map((i) => (
                <tr key={i.inviteId} className="border-t dark:border-slate-800">
                ...
                <tr>
                  <td colSpan={5} className="py-12">
                    <div className="flex flex-col items-center justify-center text-center">
                      {/* Icon */}
                      <div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#18B6B4]/10 text-[#18B6B4] mb-3">
                        <UserX size={22} />
                      </div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-xs">
                        Broker invitations or requests will appear here once
                        available.
                      </p>
                    </div>
                  </td>
