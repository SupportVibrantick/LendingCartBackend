      ...
      <div className="space-y-6">
        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="bg-gradient-to-r from-[#183b57] to-[#183b57] px-6 py-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <p className="text-xs font-medium uppercase tracking-wider text-brand-100/70">
                  Dashboard
                </p>
                <h1 className="mt-1 text-2xl font-semibold text-white">
                  Welcome back, {lenderName}
                </h1>
                <p className="mt-1 max-w-xl text-sm text-brand-50/80">
              ...
              <div className="flex flex-wrap gap-2">
                <Link
                  to="/loan-pipeline"
                  className="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-[#3e87b7] shadow-sm transition hover:bg-brand-50"
                >
                  Loan Pipeline
                  <ArrowRight size={16} />
                </Link>
        ...
        <DashboardSection
          ...
          action={
            <div className="flex items-center gap-2">
              {!loading && (
                <span className="rounded-lg bg-[#183b57]/10 px-2.5 py-1 text-[11px] font-semibold text-[#183b57]">
                  {recentCount} shown
                </span>
              )}
              <Link
                to="/loan-pipeline"
                className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs font-semibold text-[#183b57] hover:bg-[#183b57]/5"
              >
                View all
        ...
        >
          {loading ? (
            ...
            <div className="flex flex-col items-center rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 px-6 py-14 text-center dark:border-slate-700 dark:bg-slate-800/30">
              ...
              <Link
                to="/loan-pipeline"
                className="mt-5 inline-flex items-center gap-2 rounded-xl bg-[#183b57] px-4 py-2 text-sm font-semibold text-white"
              >
                Open Loan Pipeline
                <ArrowRight size={16} />
              </Link>
