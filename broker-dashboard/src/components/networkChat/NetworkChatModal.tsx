...
type NetworkChatModalProps = {
  ...
  /** Optional override; broker portal defaults to getPortalToken(). */
...
export default function NetworkChatModal({
  ...
  const getToken = useCallback(() => {
    ...
    if (portal === "broker") return getPortalToken();
    return sessionStorage.getItem(tokenKey);
  }, [getTokenProp, portal, tokenKey]);
  ...
  const scrollToBottom = useCallback((force = false) => {
    ...
    // Double rAF so layout has committed (messages after loading spinner).
  ...
  useEffect(() => {
    ...
    const sync = async () => {
      ...
      try {
        ...
        // Only follow new messages when user is already at the bottom.
    ...
    <div className="fixed inset-0 z-[1100] flex items-end sm:items-center justify-center p-0 sm:p-6">
      ...
      <div className="relative z-10 flex h-[min(720px,100dvh)] w-full max-w-2xl flex-col overflow-hidden rounded-t-3xl border border-slate-200/80 bg-white shadow-[0_25px_80px_-20px_rgba(15,23,42,0.5)] sm:rounded-3xl dark:border-slate-700 dark:bg-slate-900">
        ...
        <div
          ...
          style={{
            background: `linear-gradient(135deg, ${CHAT.primary} 0%, ${CHAT.primaryDark} 100%)`,
          }}
        >
          ...
          <div className="relative flex items-center justify-between gap-3">
            <div className="flex min-w-0 items-center gap-3">
              <div className="relative">
                ...
                <span className="absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-[#1E7BB8] bg-emerald-400" />
              </div>
        ...
        <div
          ...
          className="flex-1 space-y-1 overflow-y-auto bg-[linear-gradient(180deg,#f8fafc_0%,#e8f4fc_100%)] px-4 py-4 dark:bg-none dark:bg-slate-950"
        >
          {loading ? (
            <div className="flex h-full flex-col items-center justify-center gap-3 py-16 text-slate-500">
              <div
                className="h-8 w-8 animate-spin rounded-full border-2 border-slate-200 border-t-blue-500"
                style={{ borderTopColor: CHAT.primary }}
              />
            ...
            <div className="flex h-full flex-col items-center justify-center px-6 py-16 text-center">
              <div
                ...
                style={{ backgroundColor: CHAT.primary }}
              >
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    style={mine ? { backgroundColor: CHAT.primary } : undefined}
                  >
                    {showName && msg.senderName ? (
                      <p
                        className="mb-1 text-[11px] font-semibold"
                        style={{ color: CHAT.primary }}
                      >
                        {msg.senderName}
                      </p>
                    ) : null}
        ...
        >
          <div
            ...
            style={{ ["--tw-ring-color" as string]: `${CHAT.ring}` }}
          >
            <textarea
              value={text}
