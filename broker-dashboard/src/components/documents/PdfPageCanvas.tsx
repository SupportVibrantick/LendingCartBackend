...
export default function PdfPageCanvas({
  ...
  useEffect(() => {
    ...
    const render = async () => {
      try {
        ...
        // Draw into the exact pageManifest box so overlays (pdfRectToCss) align 1:1.
        ...
        ctx.save();
        // Prefer width-accurate mapping; if aspect differs, scale Y to pageManifest height.
  ...
  return (
    ...
    >
      ...
      {/* Editable field overlays — must sit above the canvas and receive clicks */}
