...
export default function GetLoanPage() {
  ...
  const [products, setProducts] = useState<ProductWithFields[]>([]);
            ...
            {isBroker === true && (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    {!loadingProducts ? <option value="">- Select -</option> : <option value="">- Loading... -</option>}
            ...
            selectedProductId && (
              <>
                ...
                <div className="p-6 space-y-6">
                  ...
                  {activeProduct && activeProduct.fields && activeProduct.fields.length > 0 && (
                    <div className="mt-6">
