...
const LoanPreview = () => {
  ...
  const fetchSubmittedLenders = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/loanofficer/loan-pipeline/${applicationId}/submitted-lenders`,
        {
          headers: {
            ...(token && { Authorization: `Bearer ${token}` }),
          },
  ...
  const handleSendToLender = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/loanofficer/loan-pipeline/submissions/${submissionId}/documents/submit`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const fetchSubmissionDetails = async (id: string) => {
    try {
      setLoading(true);
      const res = await fetch(
        `${API_BASE}/loanofficer/applications/submissions/${id}`,
  ...
  const fetchSubmissionDocuments = async (
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/loanofficer/loan-pipeline/submissions/${submissionId}/documents?page=${pageNo}&limit=${limit}&search=${searchQuery}`,
        {
          headers: {
            ...(token && { Authorization: `Bearer ${token}` }),
          },
  ...
  const fetchLois = async (id: string) => {
    try {
      ...
      const loiRes = await fetch(
        `${API_BASE}/loanofficer/loan-pipeline/${currentApplicationId}/lois`,
        {
          method: "GET",
          headers: getAuthHeaders(),
        },
  ...
  const handleRequestDocuments = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/loanofficer/loan-pipeline/${applicationId}/request-documents`,
        {
          method: "POST",
          headers: getAuthHeaders(),
          body: JSON.stringify({
  ...
  const fetchLenders = async (id: string) => {
    ...
    try {
      const res = await fetch(
        `${API_BASE}/loanofficer/lender-discovery/applications/submissions/${id}/eligible?page=${lenderPage}&limit=${lenderLimit}&search=${debouncedLenderSearch}&filter=${lenderFilter}`,
        {
          headers: getAuthHeaders(),
          method: "GET",
        },
  ...
  const sendApplicationToLender = async (lenderProductId: string) => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/loanofficer/lender-discovery/applications/${applicationId}/submissions/${submissionId}/send-to-lenders`,
        {
          method: "POST",
          headers: getAuthHeaders(),
          body: JSON.stringify({
  ...
  //       const res = await fetch(
  //         `${API_BASE}/loanofficer/loan-pipeline/submissions/${currentSubmissionId}/documents/${requirementId}/upload`,
  //         {
  //           method: "POST",
  //           headers: {
  //             ...(token && { Authorization: `Bearer ${token}` }),
  ...
  const handleUpdateApplication = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/loanofficer/applications/${applicationId}/edit`,
        {
          method: "PUT",
          headers: getAuthHeaders(),
                                ...
                                onChange={async (e) => {
                                  ...
                                  try {
                                    ...
                                    for (const file of Array.from(files)) {
                                      ...
                                      const res = await fetch(
                                        `${API_BASE}/loanofficer/loan-pipeline/submissions/${documentsData.submissionId}/documents/${doc.requirementId}/upload`,
                                        {
                                          method: "POST",
                                          headers: {
                                            ...(token && {
