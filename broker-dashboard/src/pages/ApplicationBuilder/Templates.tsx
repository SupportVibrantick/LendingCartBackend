      ...
      <div className="bg-slate-50 dark:bg-slate-800 rounded-[22px] p-6 h-full flex flex-col border border-transparent group-hover:border-white dark:group-hover:border-slate-700 group-hover:bg-white dark:group-hover:bg-slate-900 transition-all duration-500">
        ...
        <div className="flex justify-between items-start mb-6">
          <span
            ...
            style={{
              backgroundColor: "rgba(44,146,213,0.1)",
        ...
        <div className="flex-grow">
          <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3 group-hover:text-[#2C92D5] dark:group-hover:text-[#2C92D5] transition-colors">
            {name}
          </h3>
          ...
          <button
            ...
            className={`w-full py-4 rounded-2xl font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 ${
              isUsed
                ...
                : "bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 hover:bg-[#2C92D5] dark:hover:bg-[#2C92D5] shadow-lg"
            }`}
          >
            {isUsed ? (
              <>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-16 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-900 rounded-full shadow-sm border border-slate-100 dark:border-slate-800 mb-6">
            <TbTemplate size={16} style={{ color: "var(--primary-color)" }} />
          ...
          <p className="text-slate-500 dark:text-slate-400 text-md max-w-xl">
            Select a pre-built application template to streamline your customer
            onboarding process.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center border-2 border-dashed border-indigo-200 dark:border-indigo-900/50 rounded-3xl bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-slate-900 dark:to-slate-800">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 max-w-md">
              There are no application templates available for your account yet.
              Please contact your administrator or create a new template to get
              started.
            </p>
