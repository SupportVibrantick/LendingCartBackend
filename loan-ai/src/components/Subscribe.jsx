...
export default function SubscribePage() {
  ...
  useEffect(() => {
    ...
    const allowed = new Set(availableAddOns.map((a) => String(a.code).toUpperCase()));
  ...
  const checkoutSummary = useMemo(
    ...
    () => buildCheckoutSummary(selectedPkg, billingCycle, selectedAddOns, formatPrice),
        ...
        {user?.hasBrokerSubscription && !completed ? (
          ...
          <>
            ...
            <p className="text-slate-400 mb-8 text-sm leading-relaxed">
              ...
              Complete your subscription to activate your broker account. Choose optional add-ons

              below — everything is included in one checkout. Broker dashboard credentials will be

              sent to <strong className="text-slate-200">{user?.email}</strong>.
            ...
            {completed ? (
              ...
              <div className="space-y-4 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl p-6 backdrop-blur-xl">
                ...
                <p className="text-sm text-slate-300 leading-relaxed">
                  ...
                  We emailed broker dashboard login credentials to <strong>{user?.email}</strong>.

                  Use that email with the temporary password from the email — it is separate from

                  your Loan AI password.
              ...
              >
                      ...
                      <>
                        ...
                        <div className="border-t border-blue-500/20 pt-2 flex items-center justify-between gap-3 font-semibold text-white">
                          ...
                          <span>
                            ...
                            {checkoutSummary.totalPrice}/{checkoutSummary.billingLabel}
                ...
                <div className="rounded-xl bg-amber-500/10 border border-amber-500/30 px-4 py-3 text-xs text-amber-100/90 leading-relaxed">
                  ...
                  Payment gateway integration is coming soon. For now, completing this form
                  ...
                  and emails broker dashboard credentials to {user?.email}.
                  ...
                  {processing
                    ...
                    : user?.hasBrokerSubscription
                      ...
                      : checkoutSummary && selectedAddOns.length > 0
                        ...
                        ? `Complete subscription — ${checkoutSummary.totalPrice}`
