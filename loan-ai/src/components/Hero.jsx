    ...
    <section className="relative overflow-hidden bg-[#0b0f2a] text-white py-28 px-6">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-12">
          Simplify loan workflows, match lenders instantly, and boost efficiency
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-5">
          <button className="bg-linear-to-r from-blue-500 to-indigo-500 px-8 py-3 rounded-xl font-semibold shadow-lg hover:scale-105 hover:shadow-blue-500/30 transition">
            Register Now
          </button>

          <Link
            to="/book-demo"
            className="bg-white/10 border border-white/20 px-8 py-3 rounded-xl font-semibold backdrop-blur-md hover:bg-white/20 transition inline-block"
          >
            Book a Demo
          </Link>
        </div>
