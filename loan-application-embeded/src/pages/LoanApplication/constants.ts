...
export const LOAN_PURPOSE_MAP: Record<string, string[]> = {
  ...
  /* 1️⃣1️⃣ SBA 7a - Equipment Purchase */
  SBA_7A_EQUIPMENT_PURCHASE: [
    "New Equipment",
    "Used Equipment",
    "Refinance Existing Equipment",
  ...
  /* 1️⃣7️⃣ Accounts Receivable Finance */
  ACCOUNTS_RECEIVABLE_FINANCE: [
    "Invoice Factoring",
    "ABL Line",
    "Selective Receivable Finance",
  ...
  /* 1️⃣8️⃣ Accounts Payable Finance */
  ACCOUNTS_PAYABLE_FINANCE: [
    "Supplier Finance Program",
    "Dynamic Discounting",
    "Reverse Factoring",
...
/* ================= API base =================
 * In the embedded public-embed app we want the production URL to remain
 * the default, with an env-var override available for local dev.
 */
