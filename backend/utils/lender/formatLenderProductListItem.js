...
function formatLenderProductListItem(product) {
  ...
  return {
    ...
    amortizationMonths: toPositiveNumberOrNull(p.amortizationMonths),
    minUnits: toPositiveNumberOrNull(p.minUnits),
    maxUnits: toPositiveNumberOrNull(p.maxUnits),
    ...
    maxTermWorkingCapitalMonths: toPositiveNumberOrNull(
      p.maxTermWorkingCapitalMonths,
    ),
    ...
    cPaceEligibleJurisdictions: toStringArray(p.cPaceEligibleJurisdictions),
